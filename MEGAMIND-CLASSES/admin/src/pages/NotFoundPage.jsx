...
export function NotFoundPage() {
  return (
    <>
      <Helmet>
        <title>Page Not Found | MEGAMIND CLASSES Admin</title>
        <meta name="robots" content="noindex" />
      </Helmet>
      <section className="mx-auto max-w-xl py-16 text-center">
        <p className="text-sm font-semibold uppercase text-brand-600 dark:text-brand-100">404</p>
        <h1 className="mt-3 text-3xl font-bold">Admin page not found</h1>
        <p className="mt-3 text-slate-600 dark:text-slate-300">
          This admin route is not available in this environment yet.
        </p>
        <Link
          to="/"
