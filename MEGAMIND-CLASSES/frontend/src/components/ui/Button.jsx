  ...
  return (
    <Component
      ...
      className={clsx(
        baseButtonClasses,
        sizes[size],
        'border border-slate-300 bg-white/70 text-slate-700 hover:border-brand-500 hover:text-brand-600 dark:border-slate-700 dark:bg-slate-900/70 dark:text-slate-200 dark:hover:border-brand-400 dark:hover:text-brand-300',
        className,
      )}
      {...props}
    >
