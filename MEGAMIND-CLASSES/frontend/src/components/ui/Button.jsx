...
const baseButtonClasses =
  'inline-flex min-h-11 items-center justify-center gap-2 rounded-full font-semibold transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60 dark:focus-visible:ring-offset-slate-950';
...
export const PrimaryButton = forwardRef(function PrimaryButton(
  { as: Component = 'button', className, size = 'md', children, ...props },
  ref,
) {
  return (
    <Component
  ...
  return (
    <Component
      ...
      className={clsx(
        baseButtonClasses,
        sizes[size],
        'border border-slate-300 bg-white text-slate-700 hover:border-brand-500 hover:text-brand-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:border-brand-400 dark:hover:text-brand-300',
        className,
      )}
      {...props}
    >
